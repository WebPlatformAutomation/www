Feature: [E2E][CC Uber App Recommender v2.1]
    ...
    Scenario Outline: Single App Recommendations | CCX
        Given I go to CC Quiz Recommender page
        ...
        Examples:
        | Answers                                								   	  | Result 														 		|
		| Photography > Using templates to create content fast > Personal projects    | cc:app-reco&selectedOptions=CCX/category_photo/plan_personal 		| 
